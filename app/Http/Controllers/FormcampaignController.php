...
class FormcampaignController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $qrData = env('APP_URL') . "/pushevidence?transactionID={$validated['transactionID']}&lineId={$validated['lineId']}&campaignId={$validated['campaignsid']}&campaignname={$validated['campaignsname']}&value={$validated['value']}";
    ...
    private function sendLineMessage($userId, $lineName, $campaignsname)
    {
        ...
        $Text = "🙏ขออนุโมทนากับคุณ {$lineName}\n" .
            ...
            "แอดมินจะส่งภาพกองบุญให้ท่านได้อนุโมทนาอีกครั้งครับ\n";
